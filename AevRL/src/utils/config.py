...
class AevRLConfig(BaseModel):
    ...
    @model_validator(mode="after")
    def apply_derived_defaults(self) -> "AevRLConfig":
    ...
    @classmethod
    def from_yaml(cls, path: str | os.PathLike[str]) -> "AevRLConfig":
    ...
    @classmethod
    def from_yaml_or_dict(cls, value: str | os.PathLike[str] | dict[str, Any]) -> "AevRLConfig":
