...
from ..utils.config import AevRLConfig
...
class RolloutSample:
    ...
    )  # Stuff like group_id, etc. that will be used by the algo
...
async def run_rollouts(config: AevRLConfig) -> tuple[list[RolloutSample], list[float]]:
    n_parallel_rollouts = (
