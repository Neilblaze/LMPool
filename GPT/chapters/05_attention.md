...
> [!NOTE]
> Attention is not just a part of the Transformer. Attention IS the Transformer. Understanding this chapter is essential to understanding modern LLMs.
...
> [!IMPORTANT]
> The causal mask is critical for training. Without it, the model would "cheat" by seeing future tokens when predicting the next word.
