...
> [!TIP]
> If you don't have a GPU, start with the tiny config (4 layers, 256 dims) provided in the guide. It trains in minutes on CPU and teaches the same concepts.
...
> [!WARNING]
> Make sure to activate your virtual environment before installing packages. Installing globally can cause conflicts with other Python projects.
