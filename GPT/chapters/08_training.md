...
> [!CAUTION]
> Overfitting is when training loss decreases but generated text quality degrades. The model memorizes training data instead of learning general patterns.
